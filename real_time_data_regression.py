# Databricks notebook source exported at Thu, 15 Sep 2016 18:22:04 UTC
# MAGIC %md
...
rdd=sc.textFile("/databricks-datasets/power-plant/data/Sheet1.tsv")
rawTextRdd = rdd.take(5)
